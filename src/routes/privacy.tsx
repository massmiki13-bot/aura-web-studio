    ...
    <main className="min-h-screen bg-black text-white relative">
      ...
      <div className="relative max-w-3xl mx-auto w-full px-6 md:px-0 pt-32 pb-24">
        ...
        <Section title="2. Quali dati raccogliamo">
          <p>Raccogliamo dati personali esclusivamente quando li fornisci volontariamente tramite:</p>
          <ul className="list-disc pl-5 space-y-2">
            ...
            <li>
              ...
              Prezzi: nome e cognome, numero di telefono, email o PEC, descrizione della richiesta e,
              facoltativamente, un budget indicativo.
            </li>
          </ul>
          <p>
            Non raccogliamo dati particolari (art. 9 GDPR — es. dati sanitari, religiosi, politici) e non
            effettuiamo profilazione automatizzata dei visitatori.
          </p>
        </Section>
        ...
        <Section title="4. Come e dove conserviamo i dati">
          <p>
            ...
            infrastruttura ed hosting, che agisce in qualità di responsabile del trattamento ai sensi
            dell'art. 28 GDPR. L'accesso ai dati è riservato esclusivamente al personale autorizzato di{" "}
            {SITE_CONFIG.company}, tramite un'area riservata protetta da autenticazione.
          </p>
          <p>
            Conserviamo i dati per il tempo necessario a gestire la tua richiesta e, in caso di avvio di
            un rapporto professionale, per la durata dello stesso e per il periodo successivo richiesto
            dagli obblighi di legge (es. fiscali, contabili). In assenza di ulteriori contatti o
            conferimento di incarico, i dati vengono cancellati entro 24 mesi dalla ricezione.
          </p>
        </Section>

        <Section title="5. Con chi condividiamo i dati">
          <p>
            Non vendiamo né condividiamo i tuoi dati con terze parti per finalità di marketing. I dati
            possono essere accessibili al nostro fornitore di hosting/infrastruttura (Supabase) nella sua
            qualità di responsabile del trattamento, unicamente per l'erogazione del servizio tecnico.
          </p>
        </Section>

        <Section title="6. I tuoi diritti">
          <p>In qualsiasi momento puoi esercitare, contattandoci all'indirizzo sopra indicato, i diritti previsti dagli artt. 15-22 del GDPR:</p>
          <ul className="list-disc pl-5 space-y-2">
        ...
        <Section title="7. Cookie e tecnologie simili">
          <p>
            Questo sito <strong className="text-white">non utilizza cookie di profilazione o di
            marketing</strong> e non installa strumenti di analisi statistica di terze parti (es. Google
            Analytics). Non è quindi necessario alcun banner di raccolta del consenso per finalità
            pubblicitarie.
          </p>
          <p>Utilizziamo esclusivamente tecnologie di memorizzazione locale (cookie tecnici/localStorage), strettamente necessarie al funzionamento del sito:</p>
          <ul className="list-disc pl-5 space-y-2">
            <li>
            ...
            <li>
              <strong className="text-white">Sessione di accesso riservato</strong>: un token tecnico
              utilizzato esclusivamente dal personale {SITE_CONFIG.company} per accedere all'area
              amministrativa protetta del sito; non riguarda i visitatori pubblici.
            </li>
          </ul>
          <p>
            Trattandosi di strumenti strettamente necessari all'erogazione del servizio richiesto (art.
            122 Codice Privacy), il loro utilizzo non richiede consenso preventivo. Puoi in ogni momento
            cancellare questi dati dalle impostazioni del tuo browser.
          </p>
        </Section>

        <Section title="8. Minori">
          <p>
            Il sito non è rivolto a minori di 16 anni e non raccogliamo consapevolmente dati relativi a
            minori.
          </p>
        </Section>
        ...
        <Section title="9. Modifiche alla presente informativa">
          <p>
            Questa informativa può essere aggiornata nel tempo per riflettere modifiche normative o del
            sito. La data dell'ultimo aggiornamento è indicata in cima alla pagina.
          </p>
        </Section>
      </div>
