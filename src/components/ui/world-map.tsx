              ...
              <g>
                ...
                {showLabels && dot.end.label && (
                  <motion.g
                    ...
                    className="pointer-events-none"
                  >
                    <foreignObject x={endPoint.x - 55} y={endPoint.y - 35} width="110" height="30">
                      <div className="flex items-center justify-center h-full">
                        <span className="font-mono-spec text-[10px] uppercase tracking-widest px-2 py-0.5 rounded-md bg-black/90 text-white border border-white/15 shadow-sm">
                          {dot.end.label}
                        </span>
      ...
      <AnimatePresence>
        {hoveredLocation && (
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            exit={{ opacity: 0, y: 10 }}
            className="absolute bottom-4 left-4 bg-black/90 text-white px-3 py-2 rounded-lg font-mono-spec text-[10px] uppercase tracking-widest backdrop-blur-sm sm:hidden border border-white/15"
          >
            {hoveredLocation}
          </motion.div>
        )}
